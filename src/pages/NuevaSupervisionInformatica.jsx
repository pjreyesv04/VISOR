...
export default function NuevaSupervisionInformatica() {
  ...
  const crear = async () => {
    ...
    nav(`/supervision-informatica/${data.id}`);
  };

  return (
    <div className="container py-4" style={{ maxWidth: 900 }}>
      <h4>Nueva Supervisión Informática</h4>
      ...
      <div className="row mt-3 g-3">
        <div className="col-md-4">
          ...
          <select
            ...
            value={risId}
            onChange={(e) => setRisId(e.target.value)}
          >
        ...
        <div className="col-md-4">
          ...
          <select
            className="form-select"
            value={eessId}
            onChange={(e) => setEessId(e.target.value)}
            disabled={!risId}
          >
            <option value="">Seleccione...</option>
            {eess.map((x) => (
        ...
        <div className="col-md-9">
          ...
          {eessId && digitadores.length > 1 && (
            <small className="text-muted">
              {digitadores.length} digitador(es) disponibles
            </small>
          )}
        </div>
      </div>
